...
if (-not $SkipDb) {
    ...
    Invoke-SqlFile "sql/db_channels.sql"
    Invoke-SqlFile "sql/db_helpdesk.sql"
    Invoke-SqlFile "sql/db_sla.sql"
    Invoke-SqlFile "sql/db_actions.sql"
    Invoke-SqlFile "sql/db_observability.sql"
    Invoke-SqlFile "sql/db_eval_v2.sql"
    Invoke-SqlFile "sql/db_shopify_v2.sql"
    Invoke-SqlFile "sql/db_qa.sql"
    Invoke-SqlFile "sql/db_rbac_audit.sql"
    Invoke-SqlFile "sql/db_slo.sql"
