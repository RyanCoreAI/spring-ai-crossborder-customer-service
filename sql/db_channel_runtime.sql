-- Secure provider callbacks, encrypted channel credentials and asynchronous delivery.
-- Run after sql/db_agent_runtime.sql. Flyway installs the same schema as V17.
