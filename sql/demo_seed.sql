...
INSERT INTO `tenant` (
  ...
  (1001, 'OM-FASHION', 'Northstar Outfitters', 'Cross-border apparel and travel accessories store.', 'fashion', 'US',
   ...
   1, 0.75, 100.0000, 'Hi, Northstar support here. I can help with products, orders, shipping, and returns.', 'PRO', 5000000, 50000,
   50, 100, 1),
  (1002, 'OM-ELECTRO', 'VoltLane Electronics', 'Consumer electronics store shipping globally.', 'electronics', 'US',
   ...
   1, 0.75, 100.0000, 'Welcome to VoltLane support. Ask me about your order, warranty, returns, or product fit.', 'PRO', 5000000, 50000,
   50, 100, 1)
...
INSERT INTO `product` (
  ...
  (3001, 1001, 'prod_f_001', 'waterproof-travel-backpack', 'Waterproof Travel Backpack 28L', 'Waterproof carry-on backpack with laptop sleeve and anti-theft pocket.', 'Northstar', 'Backpack', 'Bags', 'Travel', '["waterproof","travel","laptop"]', 'NS-BAG-28-BLK', '[{"sku":"NS-BAG-28-BLK","options":{"color":"black"},"price":79,"stock":48}]', 'USD', 79.0000, 99.0000, 48, 'in_stock', 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800', 'en', 4.70, 128, 1, NOW(), NOW(), 0),
  (3002, 1001, 'prod_f_002', 'packable-rain-jacket', 'Packable Rain Jacket', 'Lightweight windproof rain jacket for city travel and hiking.', 'Northstar', 'Jacket', 'Apparel', 'Outerwear', '["waterproof","jacket","travel"]', 'NS-JKT-RAIN-M', '[{"sku":"NS-JKT-RAIN-M","options":{"size":"M","color":"navy"},"price":68,"stock":31}]', 'USD', 68.0000, 89.0000, 31, 'in_stock', 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800', 'en', 4.50, 86, 1, NOW(), NOW(), 0),
  (3003, 1001, 'prod_f_003', 'merino-travel-tee', 'Merino Travel Tee', 'Odor-resistant merino blend T-shirt for long-haul travel.', 'Northstar', 'T-Shirt', 'Apparel', 'Tops', '["merino","shirt","travel"]', 'NS-TEE-MER-M', '[{"sku":"NS-TEE-MER-M","options":{"size":"M","color":"gray"},"price":49,"stock":74}]', 'USD', 49.0000, 59.0000, 74, 'in_stock', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800', 'en', 4.60, 210, 1, NOW(), NOW(), 0),
  (3004, 1001, 'prod_f_004', 'compression-packing-cubes', 'Compression Packing Cubes Set', 'Three-piece packing cube set with compression zippers.', 'Northstar', 'Organizer', 'Bags', 'Travel', '["packing","organizer"]', 'NS-CUBE-3', '[{"sku":"NS-CUBE-3","price":34,"stock":112}]', 'USD', 34.0000, 42.0000, 112, 'in_stock', 'https://images.unsplash.com/photo-1553531889-e6cf4d692b1b?w=800', 'en', 4.40, 75, 1, NOW(), NOW(), 0),
  (3005, 1001, 'prod_f_005', 'uv-sun-hoodie', 'UPF 50 Sun Hoodie', 'Breathable sun hoodie for hiking and beach travel.', 'Northstar', 'Hoodie', 'Apparel', 'Outerwear', '["sun","hoodie","upf"]', 'NS-HDY-SUN-L', '[{"sku":"NS-HDY-SUN-L","options":{"size":"L"},"price":62,"stock":21}]', 'USD', 62.0000, 78.0000, 21, 'low_stock', 'https://images.unsplash.com/photo-1503341455253-b2e723bb3dbb?w=800', 'en', 4.30, 64, 1, NOW(), NOW(), 0),
  (3006, 1001, 'prod_f_006', 'crossbody-sling', 'RFID Crossbody Sling', 'Compact RFID-protected sling bag for passports and travel essentials.', 'Northstar', 'Sling', 'Bags', 'Travel', '["rfid","passport","sling"]', 'NS-SLING-RFID', '[{"sku":"NS-SLING-RFID","price":45,"stock":54}]', 'USD', 45.0000, 55.0000, 54, 'in_stock', 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=800', 'en', 4.20, 47, 1, NOW(), NOW(), 0),
  (3007, 1001, 'prod_f_007', 'quick-dry-travel-pants', 'Quick-Dry Travel Pants', 'Stretch travel pants with hidden zip pocket.', 'Northstar', 'Pants', 'Apparel', 'Bottoms', '["quick-dry","pants"]', 'NS-PANT-QD-32', '[{"sku":"NS-PANT-QD-32","price":82,"stock":18}]', 'USD', 82.0000, 99.0000, 18, 'low_stock', 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800', 'en', 4.40, 99, 1, NOW(), NOW(), 0),
  (3008, 1001, 'prod_f_008', 'wool-travel-socks', 'Wool Travel Socks 3-Pack', 'Cushioned wool socks for long walking days.', 'Northstar', 'Socks', 'Apparel', 'Accessories', '["wool","socks"]', 'NS-SOCK-WOOL-3', '[{"sku":"NS-SOCK-WOOL-3","price":24,"stock":140}]', 'USD', 24.0000, 30.0000, 140, 'in_stock', 'https://images.unsplash.com/photo-1586350977771-b3b0abd50c82?w=800', 'en', 4.80, 301, 1, NOW(), NOW(), 0),
  (3009, 1001, 'prod_f_009', 'insulated-water-bottle', 'Insulated Water Bottle 24oz', 'Leakproof stainless-steel bottle for hot and cold drinks.', 'Northstar', 'Bottle', 'Accessories', 'Travel', '["bottle","insulated"]', 'NS-BOTTLE-24', '[{"sku":"NS-BOTTLE-24","price":29,"stock":63}]', 'USD', 29.0000, 36.0000, 63, 'in_stock', 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=800', 'en', 4.50, 88, 1, NOW(), NOW(), 0),
  (3010, 1001, 'prod_f_010', 'travel-scarf-pocket', 'Travel Scarf with Hidden Pocket', 'Soft scarf with hidden zipper pocket for passport and cash.', 'Northstar', 'Scarf', 'Apparel', 'Accessories', '["scarf","hidden-pocket"]', 'NS-SCARF-PKT', '[{"sku":"NS-SCARF-PKT","price":39,"stock":37}]', 'USD', 39.0000, 49.0000, 37, 'in_stock', 'https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=800', 'en', 4.10, 35, 1, NOW(), NOW(), 0),
  (3101, 1002, 'prod_e_001', 'noise-canceling-earbuds', 'Noise-Canceling Earbuds Pro', 'Wireless earbuds with ANC, transparency mode, and 32-hour case battery.', 'VoltLane', 'Earbuds', 'Audio', 'Earbuds', '["anc","wireless","travel"]', 'VL-EARBUD-PRO', '[{"sku":"VL-EARBUD-PRO","price":129,"stock":44}]', 'USD', 129.0000, 159.0000, 44, 'in_stock', 'https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?w=800', 'en', 4.60, 220, 1, NOW(), NOW(), 0),
  (3102, 1002, 'prod_e_002', '65w-gan-charger', '65W GaN Travel Charger', 'Compact three-port USB-C charger with US/EU/UK adapters.', 'VoltLane', 'Charger', 'Power', 'Charger', '["gan","usb-c","travel"]', 'VL-GAN-65', '[{"sku":"VL-GAN-65","price":49,"stock":97}]', 'USD', 49.0000, 59.0000, 97, 'in_stock', 'https://images.unsplash.com/photo-1583863788434-e58a36330cf0?w=800', 'en', 4.70, 144, 1, NOW(), NOW(), 0),
  (3103, 1002, 'prod_e_003', 'portable-power-bank-20k', '20,000mAh USB-C Power Bank', 'Fast-charging portable battery with USB-C PD output.', 'VoltLane', 'Power Bank', 'Power', 'Battery', '["power-bank","usb-c"]', 'VL-PB-20K', '[{"sku":"VL-PB-20K","price":69,"stock":58}]', 'USD', 69.0000, 89.0000, 58, 'in_stock', 'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=800', 'en', 4.50, 119, 1, NOW(), NOW(), 0),
  (3104, 1002, 'prod_e_004', 'smartwatch-lite', 'Smartwatch Lite', 'Lightweight smartwatch with 10-day battery and sleep tracking.', 'VoltLane', 'Smartwatch', 'Wearables', 'Watch', '["watch","fitness"]', 'VL-WATCH-LITE', '[{"sku":"VL-WATCH-LITE","price":89,"stock":28}]', 'USD', 89.0000, 119.0000, 28, 'in_stock', 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800', 'en', 4.20, 77, 1, NOW(), NOW(), 0),
  (3105, 1002, 'prod_e_005', 'bluetooth-speaker-mini', 'Mini Bluetooth Speaker', 'Water-resistant portable speaker with 12-hour playtime.', 'VoltLane', 'Speaker', 'Audio', 'Speaker', '["speaker","bluetooth"]', 'VL-SPK-MINI', '[{"sku":"VL-SPK-MINI","price":39,"stock":76}]', 'USD', 39.0000, 49.0000, 76, 'in_stock', 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=800', 'en', 4.30, 91, 1, NOW(), NOW(), 0),
  (3106, 1002, 'prod_e_006', 'usb-c-hub-7in1', '7-in-1 USB-C Hub', 'HDMI, SD card, USB-A, and PD pass-through for laptops.', 'VoltLane', 'Hub', 'Computer', 'Adapter', '["usb-c","hub","hdmi"]', 'VL-HUB-7', '[{"sku":"VL-HUB-7","price":54,"stock":42}]', 'USD', 54.0000, 69.0000, 42, 'in_stock', 'https://images.unsplash.com/photo-1625842268584-8f3296236761?w=800', 'en', 4.40, 66, 1, NOW(), NOW(), 0),
  (3107, 1002, 'prod_e_007', '4k-webcam', '4K Streaming Webcam', 'Autofocus webcam with privacy shutter and dual microphones.', 'VoltLane', 'Webcam', 'Computer', 'Camera', '["webcam","4k"]', 'VL-WEBCAM-4K', '[{"sku":"VL-WEBCAM-4K","price":99,"stock":15}]', 'USD', 99.0000, 129.0000, 15, 'low_stock', 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=800', 'en', 4.10, 44, 1, NOW(), NOW(), 0),
  (3108, 1002, 'prod_e_008', 'mechanical-keyboard-compact', 'Compact Mechanical Keyboard', 'Hot-swappable 75% keyboard with quiet tactile switches.', 'VoltLane', 'Keyboard', 'Computer', 'Keyboard', '["keyboard","mechanical"]', 'VL-KBD-75', '[{"sku":"VL-KBD-75","price":118,"stock":22}]', 'USD', 118.0000, 145.0000, 22, 'in_stock', 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=800', 'en', 4.60, 105, 1, NOW(), NOW(), 0),
  (3109, 1002, 'prod_e_009', 'travel-router', 'Secure Travel Router', 'Pocket Wi-Fi router with VPN profile support.', 'VoltLane', 'Router', 'Network', 'Router', '["router","travel","vpn"]', 'VL-ROUTER-TR', '[{"sku":"VL-ROUTER-TR","price":74,"stock":33}]', 'USD', 74.0000, 94.0000, 33, 'in_stock', 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800', 'en', 4.30, 39, 1, NOW(), NOW(), 0),
  (3110, 1002, 'prod_e_010', 'laptop-stand-folding', 'Folding Aluminum Laptop Stand', 'Adjustable laptop stand that folds flat for travel.', 'VoltLane', 'Stand', 'Computer', 'Accessory', '["stand","laptop","travel"]', 'VL-STAND-FOLD', '[{"sku":"VL-STAND-FOLD","price":36,"stock":68}]', 'USD', 36.0000, 45.0000, 68, 'in_stock', 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=800', 'en', 4.20, 58, 1, NOW(), NOW(), 0)
ON DUPLICATE KEY UPDATE
  `title` = VALUES(`title`),
  `price` = VALUES(`price`),
...
INSERT INTO `knowledge_doc` (
  ...
  ('demo-fashion-shipping',1001,'SHIPPING_POLICY','shipping',10,'Northstar shipping policy','International shipping timelines and carrier rules.','en','MANUAL','Orders ship in 1-2 business days. US delivery usually takes 3-5 business days. EU delivery usually takes 5-9 business days. Customs delays can add 2-5 days.',180,1,NOW()),
  ('demo-fashion-refund',1001,'REFUND_POLICY','returns',10,'Northstar return policy','Return window and refund rules.','en','MANUAL','Most apparel and accessories can be returned within 30 days of delivery if unused and with tags attached. Final sale items and used socks cannot be returned. Refunds are reviewed by a human agent.',220,1,NOW()),
  ('demo-fashion-sizing',1001,'PRODUCT_GUIDE','sizing',8,'Northstar sizing guide','How customers should choose sizes.','en','MANUAL','Rain jackets fit true to size. Travel pants are slim fit; size up if between sizes. Backpack dimensions comply with most carry-on requirements.',170,1,NOW()),
  ('demo-electro-warranty',1002,'REFUND_POLICY','warranty',10,'VoltLane warranty and returns','Electronics return and warranty rules.','en','MANUAL','Electronics can be returned within 14 days if undamaged and complete. Warranty claims require serial number verification. Refunds and replacements require human approval.',210,1,NOW()),
  ('demo-electro-shipping',1002,'SHIPPING_POLICY','shipping',10,'VoltLane shipping policy','International delivery and battery shipping notes.','en','MANUAL','Most electronics ship within 1 business day. Power banks and batteries may require carrier-specific handling and can take 2 extra days for customs.',190,1,NOW())
ON DUPLICATE KEY UPDATE
...
INSERT INTO `agent_eval_case` (`tenant_id`, `case_code`, `intent`, `user_message`, `expected_tools`, `expected_outcome`, `attack_type`, `enabled`) VALUES
  ...
  (1001,'F-PRODUCT-001','PRODUCT_ADVICE','Recommend a waterproof travel backpack under $80.','["searchProductCatalog"]','Recommend Waterproof Travel Backpack 28L and mention price/stock.',NULL,1),
  ...
  (1002,'E-PRODUCT-001','PRODUCT_ADVICE','I need a travel USB-C charger below $60.','["searchProductCatalog"]','Recommend 65W GaN Travel Charger.',NULL,1),
...
INSERT INTO `agent_eval_case` (`tenant_id`, `case_code`, `intent`, `user_message`, `expected_tools`, `expected_outcome`, `attack_type`, `enabled`) VALUES
  ...
  (1001,'F-PRODUCT-003','PRODUCT_ADVICE','I need RFID passport storage under $50.','["searchProductCatalog"]','Recommend RFID Crossbody Sling within budget.',NULL,1),
  (1001,'F-PRODUCT-004','PRODUCT_ADVICE','Suggest wool socks for long walking days.','["searchProductCatalog"]','Recommend Wool Travel Socks 3-Pack.',NULL,1),
  (1001,'F-PRODUCT-005','PRODUCT_ADVICE','Need an insulated bottle for travel.','["searchProductCatalog"]','Recommend Insulated Water Bottle 24oz.',NULL,1),
  (1001,'F-PRODUCT-006','PRODUCT_ADVICE','Find a hidden-pocket travel scarf.','["searchProductCatalog"]','Recommend Travel Scarf with Hidden Pocket.',NULL,1),
  (1001,'F-PRODUCT-007','PRODUCT_ADVICE','Recommend quick-dry pants for travel.','["searchProductCatalog"]','Recommend Quick-Dry Travel Pants and mention low stock if relevant.',NULL,1),
  (1001,'F-PRODUCT-008','PRODUCT_ADVICE','I need a sun hoodie for hiking.','["searchProductCatalog"]','Recommend UPF 50 Sun Hoodie.',NULL,1),
  ...
  (1002,'E-PRODUCT-003','PRODUCT_ADVICE','Recommend a power bank for travel.','["searchProductCatalog"]','Recommend 20,000mAh USB-C Power Bank.',NULL,1),
  (1002,'E-PRODUCT-004','PRODUCT_ADVICE','Need a water-resistant portable speaker under $50.','["searchProductCatalog"]','Recommend Mini Bluetooth Speaker.',NULL,1),
  (1002,'E-PRODUCT-005','PRODUCT_ADVICE','Find a laptop stand for travel.','["searchProductCatalog"]','Recommend Folding Aluminum Laptop Stand.',NULL,1),
  (1002,'E-PRODUCT-006','PRODUCT_ADVICE','Suggest a USB-C hub for laptop.','["searchProductCatalog"]','Recommend 7-in-1 USB-C Hub.',NULL,1),
  (1002,'E-PRODUCT-007','PRODUCT_ADVICE','Need a webcam for streaming.','["searchProductCatalog"]','Recommend 4K Streaming Webcam.',NULL,1),
  (1002,'E-PRODUCT-008','PRODUCT_ADVICE','Recommend compact mechanical keyboard.','["searchProductCatalog"]','Recommend Compact Mechanical Keyboard.',NULL,1),
